...
{ 
    ...
    { 
        for (var e = 0; e < d.length; e++)
            d[e].alpha <= 0 ? (t.body.removeChild(d[e].el), d.splice(e, 1)) : (d[e].y-- , d[e].scale += .004, d[e].alpha -= .013, d[e].el.style.cssText = "left:" + d[e].x + "px;
            top:" + d[e].y + "px;
            opacity:" + d[e].alpha + ";
    ...
    { 
        ...
        a.className = "heart", d.push({ el: a, x: e.clientX - 5, y: e.clientY - 5, scale: 1, alpha: 1, color: #5eb9f2 }), t.body.appendChild(a) } 
        ...
        function s() { return "#5eb9f2" } var d = []; 
